...
// ============================================================================
// SISTEMA DE CAMPANHAS — Redirecionado para campanhas.html
// ============================================================================
// As campanhas agora são gerenciadas exclusivamente em campanhas.html
// Aqui ficam apenas as funções de motor de blocos usadas pelo quickSend
// ============================================================================

let campaignBlocks = []; // Array de blocos de ações (usado pelo quickSendModal)
let blockCounter = 0;
let savedScripts = JSON.parse(localStorage.getItem('crm_scripts') || '[]');


// Campanhas agora são na página dedicada
...
function openNewCampaign() { window.location.href = 'campanhas.html'; }
function closeNewCampaign() {} // stub
function quickSegmentCampaign(seg) { window.location.href = `campanhas.html?segment=${seg}`; }
function renderCampaigns() {} // stub
function updateCampaignStats() {} // stub
function filterCampaigns() {} // stub
function openImportFromGroup() { window.location.href = 'campanhas.html'; }

// [REMOVIDO] loadCampaignData, selectAudience, selectAudienceFromSelect — migrado para campanhas.html

// [REMOVIDO] normalizePhoneBR, buildSegmentContacts, previewAudienceSegment,
// quickSegmentCampaign (duplicata), toggleAllGroups, updateSelectedGroupsCount,
// getSelectedGroups, toggleSchedule, updateCampaignSummary — migrado para campanhas.html

// updateCampaignSummary stub (chamado por addBlock/removeBlock do quickSend)
function updateCampaignSummary() { return; }
...
function saveAsScript(containerId = 'quickSendBlocks') {
    const blocks = collectBlocksData(containerId);
...
// [REMOVIDO] openLoadScript, closeLoadScript, renderScriptsList, loadScript — migrado para campanhas.html
// Scripts são carregados via quickSendScripts no quickSendModal
